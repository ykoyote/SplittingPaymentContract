...
abstract contract TokenPaymentSplitter {
    ...
    function release(address account) public virtual {
        ...
        console.log("account is %s", account);
        console.log("_totalTokenReleased is %s", _totalTokenReleased);
        console.log("tokenTotalReceived is %s", tokenTotalReceived);
        console.log("_totalShares is %s", _totalShares);
        console.log("_tokenReleased[account] is %s", _tokenReleased[account]);
